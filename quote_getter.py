...
if __name__ == '__main__':
	...
	gsearch1 = GridSearchCV(estimator = GradientBoostingClassifier(learning_rate=0.1, min_samples_split=parameter_dict['min_samples_split'], min_samples_leaf= parameter_dict['min_samples_leaf'], subsample=parameter_dict['subsample'], random_state=parameter_dict['random_state']), param_grid = param_test1, scoring='roc_auc',n_jobs=4,iid=False, cv=5)
	...
	gsearch2 = GridSearchCV(estimator = GradientBoostingClassifier(learning_rate=0.1, n_estimators=60, max_features=parameter_dict['max_features'], subsample=parameter_dict['subsample'], random_state=10), param_grid = param_test2, scoring='roc_auc',n_jobs=4,iid=False, cv=5)
